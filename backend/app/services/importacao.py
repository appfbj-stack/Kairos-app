...
CAMPOS_KAIROS = {
    ...
    "escolaridade": ["escolaridade", "escolaridade", "education", "instrucao"],
    "profissao": ["profissao", "profissão", "occupation", "trabalho"],
    "data_conversao": ["data conversao", "conversao", "dt conversao"],
    "data_batismo": ["data batismo", "batismo", "dt batismo"],
    "data_filiacao": ["data filiacao", "filiacao", "membresia", "dt filiacao"],
    "cargo": ["cargo", "funcao", "ministerio", "role"],
    "nome_pai": ["nome pai", "pai", "father", "nome do pai"],
    "nome_mae": ["nome mae", "mae", "mãe", "mother", "nome da mae"],
    "filhos": ["filhos", "children", "dependentes"],
