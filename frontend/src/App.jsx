    ...
    <QueryClientProvider client={qc}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/celulas" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/ministerios" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/eventos" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/financas" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/oracao" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/sermoes" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/voluntarios" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/mural" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/chat" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/kairos-ai" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />
          <Route path="/aniversariantes" element={<RotaProtegida><PlaceholderPage /></RotaProtegida>} />

          <Route path="/congregacoes" element={<RotaProtegida><RotaAdmin><Congregacoes /></RotaAdmin></RotaProtegida>} />
          <Route path="/congregacoes/:id" element={<RotaProtegida><RotaAdmin><Congregacoes /></RotaAdmin></RotaProtegida>} />
